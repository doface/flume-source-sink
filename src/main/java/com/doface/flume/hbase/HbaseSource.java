...
import com.doface.flume.metrics.SqlSourceCounter;
...
public class HbaseSource extends AbstractSource implements Configurable, PollableSource {
    ...
    public void configure(Context context) {
		...
		hbaseHelper = new HbaseHelper(sqlSourceHelper);
		hbaseHelper.establishSession();
	...
	public Status process() throws EventDeliveryException {
		...
		try {
			...
			List<List<Object>> result = hbaseHelper.executeQuery(sqlSourceHelper.getLastFieldIndex());
